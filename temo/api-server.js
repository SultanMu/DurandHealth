...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log('  patient1/password123 (Patient Dashboard)');
  console.log('  hr1/password123 (Corporate Dashboard)');
  console.log('  corporate1/password123 (Corporate Dashboard)');
  console.log('  admin1/password123 (Corporate Dashboard)');
});